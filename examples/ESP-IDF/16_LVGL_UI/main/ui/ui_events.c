...
void CANSavebaud(lv_event_t * e)
{
	...
	if (strcmp(buf, "25K") == 0) {
		twai_timing_config_t t_cfg = TWAI_TIMING_CONFIG_25KBITS(); t_config = t_cfg;
	} else if (strcmp(buf, "50K") == 0) {
		twai_timing_config_t t_cfg = TWAI_TIMING_CONFIG_50KBITS(); t_config = t_cfg;
	} else if (strcmp(buf, "100K") == 0) {
		twai_timing_config_t t_cfg = TWAI_TIMING_CONFIG_100KBITS(); t_config = t_cfg;
	} else if (strcmp(buf, "125K") == 0) {
		twai_timing_config_t t_cfg = TWAI_TIMING_CONFIG_125KBITS(); t_config = t_cfg;
	} else if (strcmp(buf, "250K") == 0) {
		twai_timing_config_t t_cfg = TWAI_TIMING_CONFIG_250KBITS(); t_config = t_cfg;
	} else if (strcmp(buf, "500K") == 0) {
		twai_timing_config_t t_cfg = TWAI_TIMING_CONFIG_500KBITS(); t_config = t_cfg;
	} else if (strcmp(buf, "800K") == 0) {
		twai_timing_config_t t_cfg = TWAI_TIMING_CONFIG_800KBITS(); t_config = t_cfg;
	} else if (strcmp(buf, "1M") == 0) {
		twai_timing_config_t t_cfg = TWAI_TIMING_CONFIG_1MBITS(); t_config = t_cfg;
	}
